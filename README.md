...
Герой («intro»): две колонки одной высоты; **иконка Instagram по центру по вертикали относительно строки «Диана»**; низ «Зоопсихолог, Тбилиси» = низ ссылки «Частые вопросы», кнопка «Написать в Telegram» по центру зазора между абзацами и FAQ.
