...
Герой («intro»): на десктопе две колонки одинаковой высоты — верх «Дианы» совпадает с верхом первого абзаца, низ строки «Зоопсихолог, Тбилиси» с низом ссылки «Частые вопросы», кнопка «Написать в Telegram» вертикально по центру зазора между абзацами и FAQ.
